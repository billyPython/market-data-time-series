...
-- SELECT first(symbol) as symbol, first(open) AS open, max(high) AS high, min(low) AS low, last(close) AS close, sum(volume) AS volume, sum(tick_volume) AS tick_volume INTO ticks_4w  FROM ticks_1m GROUP BY time(4w),  symbol
-- SELECT first(symbol) as symbol, first(open) AS open, max(high) AS high, min(low) AS low, last(close) AS close, sum(volume) AS volume, sum(tick_volume) AS tick_volume INTO ticks_1w  FROM ticks_1m GROUP BY time(1w),  symbol
-- SELECT first(symbol) as symbol, first(open) AS open, max(high) AS high, min(low) AS low, last(close) AS close, sum(volume) AS volume, sum(tick_volume) AS tick_volume INTO ticks_1d  FROM ticks_1m GROUP BY time(1d),  symbol
-- SELECT first(symbol) as symbol, first(open) AS open, max(high) AS high, min(low) AS low, last(close) AS close, sum(volume) AS volume, sum(tick_volume) AS tick_volume INTO ticks_4h  FROM ticks_1m GROUP BY time(4h),  symbol
-- SELECT first(symbol) as symbol, first(open) AS open, max(high) AS high, min(low) AS low, last(close) AS close, sum(volume) AS volume, sum(tick_volume) AS tick_volume INTO ticks_1h  FROM ticks_1m GROUP BY time(1h),  symbol
-- SELECT first(symbol) as symbol, first(open) AS open, max(high) AS high, min(low) AS low, last(close) AS close, sum(volume) AS volume, sum(tick_volume) AS tick_volume INTO ticks_30m FROM ticks_1m GROUP BY time(30m), symbol
-- SELECT first(symbol) as symbol, first(open) AS open, max(high) AS high, min(low) AS low, last(close) AS close, sum(volume) AS volume, sum(tick_volume) AS tick_volume INTO ticks_15m FROM ticks_1m GROUP BY time(15m), symbol
-- SELECT first(symbol) as symbol, first(open) AS open, max(high) AS high, min(low) AS low, last(close) AS close, sum(volume) AS volume, sum(tick_volume) AS tick_volume INTO ticks_5m  FROM ticks_1m GROUP BY time(5m),  symbol
